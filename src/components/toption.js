...
const Toption = () => {
  ...
  return (
    ...
    <div className="boxes">
              <div className="box">
                <Link to={'/addform'}><button>add amount</button></Link>
              </div>
              <div className="box">
                    <Link to={'/eventwhole'}><button>add event accounts data</button></Link>
              </div>
              <div className="box">
                  <Link to={'/eventwise'}><button>add accounts data</button></Link>
              </div>
              <div className="box">
                  <Link to={'/overview'}><button>accounts overview</button></Link>
              </div>
              {/* <div className="box">
                  <button>edit accounts data</button>
              </div> */}
              <div className="box">
